...
{
    protected $signature = 'api:token {user} {--name=api} {--abilities=transactions:read,transactions:write,categories:read,categories:write,balances:read,balances:write,budgets:read,budgets:write,funds:read,funds:write}';
